...
2. Navigate to your project: `shakenfist_client`
...
**Note**: If the `shakenfist_client` package already exists on PyPI under
...
1. Go to the repository on GitHub: `shakenfist/client-python`
...
cosign verify-attestation \
    ...
    --certificate-oidc-issuer='https://token.actions.githubusercontent.com' \
    shakenfist_client-0.1.0.tar.gz
```
